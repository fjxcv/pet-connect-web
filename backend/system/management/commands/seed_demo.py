...
<<<<<<< HEAD
        ...
        post1, _ = CommunityPost.objects.update_or_create(
            author=user,
            title='雨夜捡到受伤小狸花猫，救助全过程分享',
            defaults={
                'category': 'rescue_share',
                'content': '昨晚下大雨路边发现一只后腿受伤的小狸花猫，浑身发抖不敢靠近人。买了罐头引诱后带去宠物医院，拍片发现轻微骨裂，目前住院观察，希望它早日康复，找到愿意负责的领养人。',
...
<<<<<<< HEAD
        ...
        # 一级评论
        c2, _ = CommunityComment.objects.get_or_create(
            post=post2,
            author=admin,
            parent=None,
            content='领养审核会简单核实居住环境，小型成年犬更适合租房，幼犬拆家噪音会影响邻居。'
        )
        ...
        post3, _ = CommunityPost.objects.update_or_create(
            ...
            defaults={
                'category': 'help_request',
                'content': '6月20日下午在建设路小区走失三花母猫，左耳有缺口，脖子戴红色铃铛项圈，捡到必有500元酬金，联系方式13800000002，麻烦附近居民帮忙留意。',
            },
        )
...
<<<<<<< HEAD
        ...
        post4, _ = CommunityPost.objects.update_or_create(
            ...
            defaults={
                ...
                'content': '幼猫8周龄首次体内外驱虫，9周打第一针猫三联，间隔21天第二针，12周第三针+狂犬疫苗；成年后每年一针加强疫苗，每三个月体内驱虫，每月体外驱虫。',
            },
        )
        # 收藏科普帖
...
<<<<<<< HEAD
        ...
        post5, _ = CommunityPost.objects.update_or_create(
            author=user,
            title='小鸟自制餐配比｜省一半伙食费，毛发肉眼发亮',
            defaults={
                'category': 'pet_experience',
                'content': '''踩坑无数后整理的成年鸟类通用鲜食配比，亲测半年，每月喂养成本直接减半，鸟儿毛发顺滑爆毛！
        食材重量占比
        肉类 50%｜碳水 30%｜蔬菜 18%｜油脂补充 2%
        肉类轮换鸡胸、瘦牛、三文鱼（每周 2 次深海鱼是亮毛核心）
        主食选红薯、糙米，蔬菜西兰花胡萝卜，无任何调味品
        制作：全部煮熟切碎分装冷冻，随吃随取
        成本对比：之前鸟粮月花 300+，自制仅 140-160 元
        注意：幼鸟、肾病 / 胰腺炎鸟类需要调整配比，不能直接照搬，有品种体重我可以帮忙算精准用量！''',
...
<<<<<<< HEAD
        ...
        # 6. 领养咨询：小户型上班族求低运动量少掉毛狗狗推荐
        post6, _ = CommunityPost.objects.update_or_create(
            author=user,
            title='小户型上班族求狗狗推荐！要掉毛少、运动量小，白天独自在家不拆家',
            defaults={
                'category': 'general',
                'content': '''坐标小户型公寓，每天早九晚六，加班还会晚归，想养一只小型陪伴犬，硬性需求：
        掉毛极少 / 几乎不掉，洁癖党，不想天天吸毛粘衣服；
        运动量很低，不用长时间遛弯，阴雨天在家玩就能消耗精力；
        独处稳定，白天独自在家不乱叫、不拆家，不扰民；
        体型小巧，不占空间，公寓好安置。
        目前纠结泰迪、比熊、巴哥、迷你雪纳瑞，想问问养过的铲屎官真实体验''',
            },
        )

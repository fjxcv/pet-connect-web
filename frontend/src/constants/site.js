...
export const POST_CATEGORIES = {general:'综合讨论',rescue_share:'救助分享',help_request:'求助提问',pet_experience:'养宠经验'};
export const LOST_FOUND_TYPE = {lost:'寻宠',found:'招领'};
export const LOST_FOUND_STATUS = {searching:'寻找中',found:'已找到',cancelled:'已取消'};
export const RESCUE_STATUS = {pending_rescue:'待救助',in_medical:'医疗中',recovering:'康复中',awaiting_adoption:'待领养',rescued:'已救助',abandoned:'已终止'};
